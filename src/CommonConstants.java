...
public class CommonConstants {
    ...
    // size config
    public static final Dimension FRAME_SIZE = new Dimension(548, 760);
    public static final Dimension BOARD_SIZE = new Dimension((int)(FRAME_SIZE.width * 0.96), (int)(FRAME_SIZE.height * 0.68));
